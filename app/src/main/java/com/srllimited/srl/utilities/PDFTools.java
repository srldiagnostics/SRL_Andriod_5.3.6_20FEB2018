...
/**
 * Created by Codefyne on 22-02-2017.
 */
...
public class PDFTools
{
	...
	{
		new AlertDialog.Builder(context).setTitle(R.string.app_name).setMessage(R.string.app_name)
				.setNegativeButton(R.string.app_name, null)
