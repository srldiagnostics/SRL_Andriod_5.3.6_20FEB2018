...
/**
 * Created by Codefyne on 03-05-2017.
 */
...
public class AgeCalculation
{
	public static void main(String args[])
	{
		...
		Year date = new Year(3, 5, 2017);
		Year ageAt = new Year(7, 6, 27);
	...
	public static abstract class AgeCalculate
	{
		public AgeCalculate()
		{
		}
		...
		public void calculateAGE(Year dateOfBirth, Year ageAtTheDateOf)
		{
			...
			long dayInclude = (daysInPriorMonth(dateOfBirth.month, dateOfBirth.year) - dateOfBirth.day)
					+ (ageAtTheDateOf.day);
			...
			String age;
			age = "YOUR AGE IS " + years + " Years " + monthInclude + " Months and " + dayInclude + " Days("
					+ (daysInPriorMonth(dateOfBirth.month, dateOfBirth.year) - dateOfBirth.day) + " Days of "
					+ dateOfBirth.month + "/" + dateOfBirth.year + " and " + ageAtTheDateOf.day + " Days of "
					+ ageAtTheDateOf.month + "/" + ageAtTheDateOf.year + ")";
			age += "\n";
		...
		{
			if (!isValidateNumber(date.day, 1, 31, "Day of cal") || !isValidateNumber(date.year, 0, 2999, "Year of cal")
		...
		{
			int db = dd - da, mb = md - ma, yb = yd - ya;
	...
	{
		private static final String[] monthNames = new String[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul",
				"Aug", "Sep", "Oct", "Nov", "Dec" };
