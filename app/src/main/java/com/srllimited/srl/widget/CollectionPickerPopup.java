...
public class CollectionPickerPopup extends PopupWindow implements View.OnClickListener
{
	...
	//	public static final int DEFAULT_MIN_YEAR = 2000;
	...
	private CollectionPickerPopup.OnColDatePickedListener mListener;

	public CollectionPickerPopup(CollectionPickerPopup.Builder builder)
	{
	...
	public interface OnColDatePickedListener
	{
	...
	public static class Builder
	{
		...
		private final int min = Calendar.getInstance().get(Calendar.YEAR);
		Calendar calendar = Calendar.getInstance();
		//Required
		private Context context;
		private OnColDatePickedListener listener;
		//Option
		private boolean showDayMonthYear = false;
		//		private final int minYear = Calendar.getInstance().get(Calendar.YEAR);
		...
		public Builder(Context context, CollectionPickerPopup.OnColDatePickedListener listener)
		{
			this.context = context;
			this.listener = listener;
		}

		//		public CollectionPickerPopup.Builder minYear(int minYear)
		//		{
		//			return this;
		//		}
		//
		//		public CollectionPickerPopup.Builder maxYear(int maxYear)
		//		{
		...
		public CollectionPickerPopup.Builder dateChose(String dateChose)
		{
			this.dateChose = dateChose;
			return this;
		}

		public CollectionPickerPopup.Builder colorCancel(int colorCancel)
		{
			this.colorCancel = colorCancel;
			return this;
		}

		public CollectionPickerPopup.Builder colorConfirm(int colorConfirm)
		{
		 ...
		 * @param textSize dp
		 */
		public CollectionPickerPopup.Builder btnTextSize(int textSize)
		{
			this.btnTextSize = textSize;
			return this;
		}

		public CollectionPickerPopup.Builder viewTextSize(int textSize)
		{
			this.viewTextSize = textSize;
			return this;
		}

		public CollectionPickerPopup build()
		{
			if (minYear > maxYear)
			{
				throw new IllegalArgumentException();
			}
			return new CollectionPickerPopup(this);
		}

		public CollectionPickerPopup.Builder showDayMonthYear(boolean useDayMonthYear)
		{
