...
public class OTPLogin_PatientDetailAdapter extends RecyclerView.Adapter<OTPLogin_PatientDetailAdapter.ViewHolder>
{
	private Context mContext;

	private List<PatientDetailsData> mPatientDetailsDatas = new ArrayList<>();
	public static PatientDetailsData patientDetailsDataobj;
    View oldselectedview;
	private String lastname = "";
	public static boolean selectionflag=false;
	public OTPLogin_PatientDetailAdapter(Context context, List<PatientDetailsData> patientDetailsDatases)
	{
	...
	@Override
	public OTPLogin_PatientDetailAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, final int i)
	{
	...
	@Override
	public void onBindViewHolder(final OTPLogin_PatientDetailAdapter.ViewHolder viewHolder, final int i)
	{
						...
						&& !mPatientDetailsDatas.get(i).getFIRST_NAME().equalsIgnoreCase("null"))
				{
					...
					viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View view) {
							patientDetailsDataobj=new PatientDetailsData();
