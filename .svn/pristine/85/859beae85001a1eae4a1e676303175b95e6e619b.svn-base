...
import com.srllimited.srl.widget.stikkyheaders.animator.HeaderStikkyAnimator;
...
public abstract class StikkyHeaderBuilder
{
	...
	public static class ListViewBuilder extends StikkyHeaderBuilder
	{
		...
		public StikkyHeaderListView build()
		{
			...
			final StikkyHeaderListView stikkyHeaderListView = new StikkyHeaderListView(mContext, mListView, mHeader,
	...
	public static class RecyclerViewBuilder extends StikkyHeaderBuilder
	{
		...
		public StikkyHeaderRecyclerView build()
		{
			...
			final StikkyHeaderRecyclerView stikkyHeaderRecyclerView = new StikkyHeaderRecyclerView(mContext,
					mRecyclerView, mHeader, mMinHeight, mAnimator);
	...
	public static class ScrollViewBuilder extends StikkyHeaderBuilder
	{
		...
		public StikkyHeaderScrollView build()
		{
			...
			final StikkyHeaderScrollView stikkyHeaderScrollView = new StikkyHeaderScrollView(mContext, mScrollView,
					mHeader, mMinHeight, mAnimator);
	...
	public static class TargetBuilder extends StikkyHeaderBuilder
	{
		...
		public StikkyHeaderTarget build()
		{
			...
			final StikkyHeaderTarget stikkyHeaderTarget = new StikkyHeaderTarget(mContext, mHeader, mMinHeight,
					mAnimator);
