...
public class StikkyHeaderScrollView extends StikkyHeader
{
	...
	StikkyHeaderScrollView(final Context context, final ScrollView scrollView, final View header,
			final int minHeightHeader, final HeaderAnimator headerAnimator)
	{
	...
	protected void setHeightHeader(int heightHeader)
	{
		...
		mScrollView.setPadding(mScrollView.getPaddingLeft(), mScrollView.getPaddingTop() + heightHeader,
				mScrollView.getPaddingRight(), mScrollView.getPaddingBottom());
	}
